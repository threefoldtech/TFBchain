...
<head>
	<title>TFB Faucet</title>
</head>
<body>
	<div align="center">
		<h1 style="margin-top:3em">tfbchain {{.ChainNetwork}} faucet</h1>
		...
		<h3>Request %[1]d TFB by entering your address below and submitting the form.</h3>
		<form action="/request/tokens" method="POST">
			<div>Address: <input type="text" size="78" name="uh"></div>
			<br>
			<div><input type="submit" value="Request %[1]d TFB" style="width:20em;height:2em;font-weight:bold;font-size:1em;"></div>
		</form>

		
	
		<div style="margin-top:50px;"><small>tfbchain faucet</small></div>
	</div>
</body>
`, coinsToGive))
...
<body>
	<div align="center">
		<h1>%d TFB succesfully transferred on tfbchain's {{.ChainNetwork}} to {{.Address}}</h1>
